    ...
    <section className="min-vh-100 relative hero" style={{ backgroundColor: 'var(--color-background-white)' }}>
      <Container>
        <div className="flex flex-column items-center justify-center min-vh-100 tc">
          ...
          <div className='flex flex-column-2 items-center column-right'>
            <div className="mb4">
              ...
              <div>
                <h2 className="f2 fw7">
                  <span className='flex'>
                    Unite, Innovate,<img src={smallcard} alt="small card" /> 
                  </span>
                </h2>
                <h2 className="f2 fw7"> 
                  <span className='flex'>
                    <img src={smallcard2} alt="small card" />Connect, Inspire Together 
                  </span>
                </h2>
              </div>
              <div className='flex flex-column-2 items-center'>
                ...
                >
                  <div className='white flex items-center justify-space-between'>
                    View Our Services
                    <img src={arrow} alt="arrow" className='arrow p2 m4' />
                  </div>
                </button>
                <span className="f4"><img src={people} alt="8 people" /></span>
              </div>
            </div>
